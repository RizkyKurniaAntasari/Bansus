...
<body class="bg-[#ffcc00] min-h-screen flex items-center justify-center">
    ...
    <div class="flex bg-[#ffcc00] w-full max-w-4xl mx-auto rounded-lg overflow-hidden">
        <div class="w-2/3 bg-[#ffcc00] p-8 flex flex-col items-start justify-center pl-12">
        ...
        <div class="w-1/2 bg-white p-8 flex flex-col justify-center items-center rounded-lg shadow-2xl">
            <div class="w-full max-w-md">
                <div class="flex items-center mb-6 justify-center">
                    <span class="text-gray-800 font-semibold text-lg text-center">Website Oprec Asdos</span>
                </div>

                <h2 class="text-4xl font-bold text-gray-800 text-center">Create</h2>
                <h2 class="text-4xl font-bold text-gray-800 mb-8 text-center">Account</h2>
